...
(96, 1593085098900, 'M009', 'ＨＩ', 0, 1, -2, NULL, 'IMG_6908.JPG');
...
--
ALTER TABLE `orders`
  MODIFY `orderId` int(5) NOT NULL AUTO_INCREMENT COMMENT '訂單編號', AUTO_INCREMENT=155;

--
-- AUTO_INCREMENT for table `order_lists`
--
ALTER TABLE `order_lists`
  MODIFY `orderListId` int(10) NOT NULL AUTO_INCREMENT COMMENT '明細編碼', AUTO_INCREMENT=272;

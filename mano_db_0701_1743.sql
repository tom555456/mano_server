...
--
-- Host: localhost
-- Generation Time: Jul 01, 2020 at 11:43 AM
...
(99, '陳辛蒂', 7, 790, '2020-07-01 13:39:30', '2020-07-01 13:39:30');
...
(23, 'M010', '陳辛蒂', '手摘', '和平東路', '南投縣', '埔里鎮', 878, '0987778788', '0126cloud@gmail.com', '768393aea7fef8c37a6df9ff7c3a9c230a55a9fe', '貨到付款', '大有路一段92號', '2020-04-29 00:00:00', '1593015497494.jpg', '2020-04-29 12:11:57', '2020-07-01 13:44:37'),
...
(156, 1593583786431, 'M010', '陳辛蒂', '0987778788', '南投縣', '埔里鎮', '大有路一段92號', '2020-07-01 22:09:46', '未出貨', 'ATM轉帳', '未付款', '2020-07-01 14:09:46', 0, 0, 2800, '', '2020-07-01 14:09:46'),
(157, 1593583967147, 'M010', '陳辛蒂', '0987778788', '南投縣', '埔里鎮', '大有路一段92號', '2020-07-01 22:12:47', '未出貨', 'LinePay', '未付款', '2020-07-01 14:12:47', 0, 680, 1020, '', '2020-07-01 14:12:47'),
(158, 1593584091924, 'M010', '陳辛蒂', '0987778788', '南投縣', '埔里鎮', '大有路一段92號', '2020-07-01 22:14:51', '未出貨', '信用卡', '已付款', '2020-07-01 14:14:51', 0, 0, 500, '', '2020-07-01 14:14:51'),
(159, 1593585912638, 'M010', '陳辛蒂', '0987778788', '南投縣', '埔里鎮', '大有路一段92號', '2020-07-01 22:45:12', '未出貨', 'ATM轉帳', '未付款', '2020-07-01 14:45:12', 100, 38, 712, '', '2020-07-01 14:45:12');
...
(274, '156', '3', '立領排釦外套', '', '', 650, 3, 1950, '2020-07-01 14:09:46', '2020-07-01 14:09:46'),
(275, '156', '', '', '1', '抹茶茶道課', 850, 1, 850, '2020-07-01 14:09:46', '2020-07-01 14:09:46'),
(276, '157', '', '', '1', '抹茶茶道課', 850, 2, 1700, '2020-07-01 14:12:47', '2020-07-01 14:12:47'),
(277, '158', '', '', '3', '抹茶毛巾卷', 500, 1, 500, '2020-07-01 14:14:51', '2020-07-01 14:14:51'),
(278, '159', '3', '立領排釦外套', '', '', 650, 1, 650, '2020-07-01 14:45:12', '2020-07-01 14:45:12');
...
(95, 158, 'cindyyy ', '0000-0000-0000-0000', '11/11', 123, '123', '2020-07-01 14:14:51', '2020-07-01 14:14:51');
...
(33, 'M010', 'D311', 1, '2020-07-01 14:12:47', '2020-06-25 00:14:37'),
...
--
ALTER TABLE `forget_password`
  MODIFY `fId` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `item_tracking`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=100;
...
--
ALTER TABLE `orders`
  MODIFY `orderId` int(5) NOT NULL AUTO_INCREMENT COMMENT '訂單編號', AUTO_INCREMENT=160;

--
-- AUTO_INCREMENT for table `order_lists`
--
ALTER TABLE `order_lists`
  MODIFY `orderListId` int(10) NOT NULL AUTO_INCREMENT COMMENT '明細編碼', AUTO_INCREMENT=279;

--
-- AUTO_INCREMENT for table `order_payment`
--
ALTER TABLE `order_payment`
  MODIFY `orderPaymentId` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
